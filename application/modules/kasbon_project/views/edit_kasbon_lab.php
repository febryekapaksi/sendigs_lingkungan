                ...
                <tbody>
                    ...
                    foreach ($list_data_lab as $item) {
                        if (isset($list_arr_kasbon[$item->id_lab])) {
                            ...
                            $qty_pengajuan = (isset($list_arr_kasbon[$item->id_lab])) ? $list_arr_kasbon[$item->id_lab]['qty_pengajuan'] : 0;
                            $nominal_pengajuan = (isset($list_arr_kasbon[$item->id_lab])) ? $list_arr_kasbon[$item->id_lab]['nominal_pengajuan'] : 0;
                            $total_pengajuan = (isset($list_arr_kasbon[$item->id_lab])) ? $list_arr_kasbon[$item->id_lab]['total_pengajuan'] : 0;
                            $aktual_terpakai = (isset($list_arr_kasbon[$item->id_lab])) ? $list_arr_kasbon[$item->id_lab]['aktual_terpakai'] : 0;
                            if ($aktual_terpakai <= 0) {
                                $aktual_terpakai = $item->qty_final;
                            }
                            $sisa_budget = (isset($list_arr_kasbon[$item->id_lab])) ? $list_arr_kasbon[$item->id_lab]['sisa_budget'] : 0;
                            if ($sisa_budget <= 0) {
                            ...
                            echo '<input type="hidden" name="detail_lab[' . $no . '][nm_item]" value="' . $item->nm_biaya . '">';
                            echo '</td>';
                            ...
                            echo '<input type="hidden" name="detail_lab[' . $no . '][total_budget_estimasi]" value="' . $item->total_final . '">';
                            echo '</td>';
                            ...
                            echo '<input type="hidden" name="detail_lab[' . $no . '][nominal_terpakai]" value="' . $nominal_terpakai . '">';
                            echo '</td>';
                            ...
                            echo '<input type="hidden" name="detail_lab[' . $no . '][qty_overbudget]" value="' . $qty_overbudget . '">';
                            echo '</td>';

                            echo '<td class="text-right">';
                            echo ($qty_overbudget > 0) ? number_format($nominal_overbudget, 2) : '-';
                            echo '<input type="hidden" name="detail_lab[' . $no . '][nominal_overbudget]" value="' . $nominal_overbudget . '">';
                            echo '</td>';

                            echo '<td class="text-right">';
                            echo ($qty_overbudget > 0) ? number_format($total_overbudget, 2) : '-';
                            echo '<input type="hidden" name="detail_lab[' . $no . '][total_overbudget]" value="' . $total_overbudget . '">';
                            echo '<input type="hidden" name="detail_lab[' . $no . '][sisa_budget]" value="' . $sisa_budget . '">';
                            echo '<input type="hidden" name="detail_lab[' . $no . '][aktual_terpakai]" value="' . $aktual_terpakai . '">';
                            echo '</td>';
                ...
                <tbody>
                    ...
                    foreach ($list_data_lab as $item) {
                        if (isset($list_arr_kasbon[$item->id_lab])) {
                            ...
                            echo '<td>';
                            echo '<input type="number" name="detail_lab[' . $no . '][qty_pengajuan]" class="form-control form-control-sm text-right" onchange="hitung_all_pengajuan()" step="0.01" value="' . $qty_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';

                            echo '<td>';
                            echo '<input type="text" name="detail_lab[' . $no . '][nominal_pengajuan]" class="form-control form-control-sm text-right auto_num hitung_per_price" data-no="' . $no . '" data-budget="' . $item->price_unit_final . '" value="' . $nominal_pengajuan . '" ' . $readonly . '>';
                            echo '</td>';

                            echo '<td>';
                            echo '<input type="text" name="detail_lab[' . $no . '][total_pengajuan]" class="form-control form-control-sm text-right auto_num" onchange="hitung_all_pengajuan()" value="' . $total_pengajuan . '" readonly>';
                            echo '</td>';
        ...
        if (valid == '0') {
            ...
            swal({
                ...
                if (next) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: siteurl + active_controller + 'update_kasbon_lab',
                        data: formData,
                        cache: false,
                        processData: false,
                        contentType: false,

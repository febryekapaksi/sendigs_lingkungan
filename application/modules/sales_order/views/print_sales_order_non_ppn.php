    ...
    <table style="width: 100%" border="1">
        <thead>
            <tr>
                ...
                <th class="text-center" style="padding:10px; border: 1px solid black;">Product Category</th>
                <th class="text-center" style="padding:10px; border: 1px solid black;">Product Code</th>
                <th class="text-center" style="padding:10px; border: 1px solid black;">Product Description</th>
        ...
        <tbody>
            ...
            foreach ($results['data_penawaran_detail'] as $item) :
                ...
                echo '<td class="text-center" style="padding: 10px;border: 1px solid black;">'.$item->product_category.'</td>';
    ...
    <table style="width:100%; min-height: 100px;"  border="1">
        <tr>
            <td style="vertical-align: top;">
                <span>Note :</span> <br>
                <span><?= $results['data_penawaran']->notes ?></span>
            </td>
        </tr>
    </table>
    <br>

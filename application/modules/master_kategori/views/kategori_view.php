        ...
        <div class="col-md-12">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="<?php echo site_url('master_kategori'); ?>">
                            Data Kategori</a>
                    </li>
                    <li><a href="<?php echo site_url('master_kategori/kategori_new'); ?>">
                            Tambah Kategori</a>
                    </li>
                </ul>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="my-grid" class="table table-striped table-bordered table-hover" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="column-hide" width="50">Nomor</th>
                                                <th class="">Nama kategori</th>
                                                <th class="no-sort" width="17%">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                    </table>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary save_edit_kategori"><i class="fa fa-save"></i> Simpan</button>
...
<script type="text/javascript">
    ...
    function datatables() {
        ...
        var dataTable = $('#my-grid').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url('master_kategori/display_kategori_json'); ?>",
                type: "post",
                error: function() {
                    $(".my-grid-error").html("");
    ...
    $(document).on('click', '.save_edit_kategori', function() {
        swal({
            ...
            if(next) {
                ...
                $.ajax({
                    type: 'post',
                    url: siteurl + active_controller + 'save_edit_kategori',
                    data: formData,
                    cache: false,
                    dataType: 'JSON',
                    success: function(result) {
    ...
    $(document).on('click', '.delete_kategori', function() {
        ...
        swal({
            ...
            if(next) {
                ...
                $.ajax({
                    type: 'post',
                    url: siteurl + active_controller + 'delete_kategori',
                    data: {
                        'id': id
                    },
                    cache: false,

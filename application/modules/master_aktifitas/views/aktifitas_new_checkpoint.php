            ...
            <tbody>
                ...
                if ($cek_point->num_rows() > 0) {
                    ...
                    foreach ($cek_point->result() as $d) {
                        ...
                        if ($no > 1) {
                ?>
                            <a href='#' id='RemoveCheck' title='Hapus Baris' class='btn btn-xs btn-danger'>
...
<script type="text/javascript">
    $(document).ready(function() {
        var btnSave = "<button type='button' class='btn btn-sm btn-primary' id='SaveFormPoint' data-form-id='<?php echo $form_id; ?>'><i class='fa fa-plus'></i> Simpan</button>";

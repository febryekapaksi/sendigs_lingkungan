            ...
            <div class="col-md-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li><a href="<?php echo site_url('master_aktifitas'); ?>">
                                Data aktifitas</a>
                        </li>
                        <li class="active"><a href="<?php echo site_url('master_aktifitas/aktifitas_new/'); ?>">
                                Tambah aktifitas</a>
                        </li>
                    </ul>
...
<script type="text/javascript">
    ...
    function AppendBaris() {
        ...
        var Hapus = "<a href='#' id='Batalkan' title='Hapus Baris'><i class='fa fa-trash'></i></a>";
        if (Nomor == 1) {
            Hapus = "";
        }
        var Baris = "<tr>";

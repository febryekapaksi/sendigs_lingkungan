...
// 	$no_bom 			= $valx['no_bom'];
	...
	$link 	= $code_lv4 . ', ' . $no_bom. ', ' . $NmProduct;
	...
	$images	= "
		<table class='gridtable' style='width:100%;' border='0' cellpadding='0' cellspacing='0'>
			<tr>
				...
				<td style='vertical-align:top; padding-right: -5px; padding-top: 7px;'>&nbsp;<b>PT ORIGA MULIA FRP</b><br>" . $NmProduct . "</td>
			</tr>
		</table>
		";
	echo $images;
...
$mpdf->WriteHTML($html);
$mpdf->Output("qrcode-".$no_bom.".pdf", 'I');
